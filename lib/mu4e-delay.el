...
;; somehow I need to reeval this function, otherwise I get the error:
;; Error running timer `mu4e-delay-send-delayed-mails': (void-function nnheader-header-value)
...
;;bind it
(define-key mu4e-compose-mode-map (kbd "C-c t") 'mu4e-delay-add-delay-header)
